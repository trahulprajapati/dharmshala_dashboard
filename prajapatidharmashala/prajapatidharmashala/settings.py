"""
Django settings for prajapatidharmashala project.
...
SECRET_KEY = 'c^byw%%$d_c&)(r_6jf$o9$gnjngh_6eey@-!!669hgojnme+#'
...
WSGI_APPLICATION = 'prajapatidharmashala.wsgi.application'
